...
public class CS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/InfoBG.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
				...
				score= score+10;
                                ...
                                if(difficulty == 0)
				CSQuestionChanger.newEasyQuestion();
                                else {
                                if(difficulty == 1)
				CSQuestionChanger.newNormalQuestion();
                                else
				CSQuestionChanger.newHardQuestion();
                                }
    ...
    public void end(){
        if(currquestion==6){
            CSScorePage scorePage = new CSScorePage();
