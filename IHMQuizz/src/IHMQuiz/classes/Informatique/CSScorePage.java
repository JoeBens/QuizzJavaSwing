 ...
 * @author Joe
 */
public class CSScorePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/CSScore.png"))); // NOI18N
    ...
    public void setScoreText(int score){
        ...
        if(score > Integer.parseInt(highScore)){
            ...
            File scoreFile = new File("csHighScore.dat");
            if(!scoreFile.exists()){
                try {
                    scoreFile.createNewFile();
                } catch (IOException ex) {
                    Logger.getLogger(CSScorePage.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public String getHighScore(){
        ...
        try{
           readFile = new FileReader("csHighScore.dat");  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSScorePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CSScorePage().setVisible(true);
