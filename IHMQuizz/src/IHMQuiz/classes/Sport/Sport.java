...
public class Sport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/SportsBG.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
				...
				score= score+10;
                                ...
                                if(difficulty == 0)
				SportQuestionChanger.newEasyQuestion();
                                else {
                                if(difficulty == 1)
				SportQuestionChanger.newNormalQuestion();
                                else
				SportQuestionChanger.newHardQuestion();
                                }
...
jLabel3.setText("SCORE: "+score);
    ...
    public void end(){
        if(currquestion==6){
            SportScorePage scorePage = new SportScorePage();
