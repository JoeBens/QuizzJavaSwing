 ...
 * @author Joe
 */
public class JVScorePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/JVSCORE.png"))); // NOI18N
    ...
    public void setScoreText(int score){
        ...
        if(score > Integer.parseInt(highScore)){
            ...
            File scoreFile = new File("jvHighScore.dat");
            if(!scoreFile.exists()){
                try {
                    scoreFile.createNewFile();
                } catch (IOException ex) {
                    Logger.getLogger(JVScorePage.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public String getHighScore(){
        ...
        try{
           readFile = new FileReader("jvHighScore.dat");  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JVScorePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JVScorePage().setVisible(true);
