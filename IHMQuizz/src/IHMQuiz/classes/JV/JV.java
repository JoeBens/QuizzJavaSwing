...
public class JV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/JVBG.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
				...
				score= score+10;
                                ...
                                if(difficulty == 0)
				JVQuestionChanger.newEasyQuestion();
                                else {
                                if(difficulty == 1)
				JVQuestionChanger.newNormalQuestion();
                                else
				JVQuestionChanger.newHardQuestion();
                                }
    ...
    public void end(){
        if(currquestion==6){
            JVScorePage scorePage = new JVScorePage();
