...
public class JVQuestionChanger {
	...
	static JV quiz;
	static JVQuestions questions;
	static String currQuestion;
        
        public int difficulty;
	public JVQuestionChanger(int diff) {
		quiz = new JV(diff);
                quiz.resetScore();
