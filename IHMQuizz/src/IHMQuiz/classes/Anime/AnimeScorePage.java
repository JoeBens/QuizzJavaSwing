 ...
 * @author Joe
 */
public class AnimeScorePage extends javax.swing.JFrame {

    String highScore = "";
    /**
     * Creates new form ScorePage
     */
    public AnimeScorePage() {
        if (highScore.equals("")){
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/AnimeScore.png"))); // NOI18N
    ...
    public void setScoreText(int score){
        ...
        if(score > Integer.parseInt(highScore)){
            ...
            File scoreFile = new File("animeHighScore.dat");
            if(!scoreFile.exists()){
                try {
                    scoreFile.createNewFile();
                } catch (IOException ex) {
                    Logger.getLogger(AnimeScorePage.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public String getHighScore(){
        ...
        try{
           readFile = new FileReader("animeHighScore.dat");  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimeScorePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimeScorePage().setVisible(true);
