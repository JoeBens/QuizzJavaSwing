...
public class Sante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/SantéBG.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
				...
				score= score+10;
                                ...
                                if(difficulty == 0)
				SanteQuestionChanger.newEasyQuestion();
                                else {
                                if(difficulty == 1)
				SanteQuestionChanger.newNormalQuestion();
                                else
				SanteQuestionChanger.newHardQuestion();
                                }
    ...
    public void end(){
        if(currquestion==6){
            SanteScorePage scorePage = new SanteScorePage();
