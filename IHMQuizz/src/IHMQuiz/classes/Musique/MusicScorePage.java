 ...
 * @author Joe
 */
public class MusicScorePage extends javax.swing.JFrame {

    String highScore = "";
    /**
     * Creates new form ScorePage
     */
    public MusicScorePage() {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IHMQuiz/11_mr_navaa_90.jpg"))); // NOI18N
    ...
    public void checkHighScore(int score){
        if(score > Integer.parseInt(highScore)){
            ...
            File scoreFile = new File("musicHighScore.dat");
            if(!scoreFile.exists()){
                try {
    ...
    public String getHighScore(){
        ...
        try{
           readFile = new FileReader("musicHighScore.dat");  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MusicScorePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MusicScorePage().setVisible(true);
